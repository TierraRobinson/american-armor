var simplemaps_usmap_mapdata = {
    ...
    locations:{
      0: {
        ...
        lng: -74.0059731,
        color: 'default',
        url: 'cities/simple-message-board/NYC.html',
      },
      ...
      1: {
      	...
      	lng: -76.1474,
      	color: 'default',
      	url: 'cities/simple-message-board/Syracuse.html',
      },
      ...
      2: {
      	...
      	lng: -78.8784,
      	color: 'default',
      	url:'cities/simple-message-board/Buffalo.html',
      },
      ...
      3: {
      	...
      	lng: -77.6088,
      	color: 'default',
      	url: 'cities/simple-message-board/Rochester.html',
      },
      ...
      4: {
      	...
      	lng: -73.8987,
      	color: 'default',
      	url: 'cities/simple-message-board/Yonkers.html',
      },
